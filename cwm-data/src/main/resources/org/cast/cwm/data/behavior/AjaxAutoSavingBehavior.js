...
var AutoSaver = {
    ...
    autoSaveCheck: function () {
        ...
        $.each(AutoSaver.onBeforeSaveCallBacks, function (key, value) {
            try {
                ...
                AutoSaver.onBeforeSaveCallBacks.splice(key, 1)
                /* Probably a stale callback; remove it. */
            }
        });
    ...
    addForm: function (formId, ajaxCallbackUrl) {
        ...
        AutoSaver.logger("AutoSave: Registering Form ", formId, " with URL ", form.data('ajaxCallbackUrl'));
    },
