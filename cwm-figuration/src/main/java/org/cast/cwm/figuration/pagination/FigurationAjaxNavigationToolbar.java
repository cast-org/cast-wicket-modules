 ...
 * @author bgoldowsky
 */
public class FigurationAjaxNavigationToolbar extends FigurationNavigationToolbar {
	 ...
	 */
	public FigurationAjaxNavigationToolbar(DataTable<?, ?> table) {
		super(table);
	}

	@Override
	protected PagingNavigator newPagingNavigator(String navigatorId, DataTable<?, ?> table) {
		return new FigurationAjaxPagingNavigator(navigatorId, table);
	}
