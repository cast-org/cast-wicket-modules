 ...
 *
 */
public class PlayerPanel<T extends UserContent> extends GenericPanel<T> implements IHeaderContributor {
	...
	public PlayerPanel(String id, IModel<T> mUserContent, WamiAppletHolder appletHolder) {
		this(id, mUserContent);
		this.appletHolder = appletHolder;
	}

	public PlayerPanel(String id, IModel<T> mUserContent) {
